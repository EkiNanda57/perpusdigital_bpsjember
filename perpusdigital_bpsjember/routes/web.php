...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/publikasi/detail/{id}', [PublikasiController::class, 'show'])->name('publikasi.detailpublikasi');
    Route::get('/publikasi/unduh/{id}', [PublikasiController::class, 'unduh'])->name('publikasi.unduh');
